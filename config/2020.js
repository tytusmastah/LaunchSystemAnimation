...
let config = {
    ...
    filename: "2020launcher",   //filename to save movie
    timeStart: 0,       //start time in seconds - should be left as 0
    timeEnd: 1326,      //1314 end time in senconds - how long timeline will be animated
    density: 6,         //unused
...
let cpoints =  [
    ...
    { timeh: 0, timem: 4, times: 6, title: "różne takie", pos: -1 },
    ...
    { timeh: 0, timem: 15, times: 8, title: "siatkówka", pos: -1 },
    ...
    { timeh: 0, timem: 21, times: 7, title: "Retrospekcje", pos: -1 },
    { timeh: 0, timem: 22, times: 5, title: "Prawdziwy koniec", pos: 1 }
    ];
 ...
 */    
let csubtitles2 = [
    { start: [0, 0, 24], end: [0, 0, 61], text: "Rok 2020 rozpoczął się jeszcze w listopadzie 2019" },        
    { start: [0, 3, 56], end: [0, 3, 58], text: "Jestem kucharzeeeem" },        
    { start: [0, 4, 59], end: [0, 5, 8], text: "Promocja Franka na ministranta" },        
    { start: [0, 6, 18], end: [0, 6, 32], text: "Domowe, covidowe zajęcia parkour" },        
    { start: [0, 7, 58], end: [0, 8, 3], text: "Widzisz, nie utopiłeś się!" },        
    ...
    { start: [0, 21, 58], end: [0, 22, 5], text: "Coś na kształt uderzeń młota w scenie po napisach Avengers End Game" }        
    ];
...
let csubtitles = [
    ...
    { start: [0, 17, 25], end: [0, 21, 6], text: "Kwiat jabłoni - Dziś późno pójdę spać", size: 12 }        
    ];
